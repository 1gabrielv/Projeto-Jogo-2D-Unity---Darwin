...
public class esq2 : MonoBehaviour
{
GameObject pontoA;
    GameObject pontoB;
    Rigidbody2D rb;
    ...
    private int maxHits = 2; // Número máximo de danos antes de morrer
    ...
    private IEnumerator HandleDeath()
    {
        ...
        yield return new WaitForSeconds(0.7f); // Espera a duração da animação de morte
