...
public class cogumelo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pontoA = GameObject.Find("pa cogumelo");
        pontoB = GameObject.Find("pb cogumelo");
        ...
        attackHitbox = transform.Find("attackCogu").gameObject;
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (direction.x > 0)
            {
                attackHitbox.transform.localPosition = new Vector2(0.8f, -0.5f); // Posição à direita
            }
            else
            {
                attackHitbox.transform.localPosition = new Vector2(0f, -0.5f); // Posição à esquerda
            }
